...
- Localize wherever they appear: category, title, subtitle, headline, deck, lead, summary, sectionTitle, sectionContent, conclusion, verdict, scoreLabel, aggregateRatingLabel, galleryTitle, videoGalleryTitle, gallery item title & caption, video item title & caption, keyFindings / keyPoints / strengths / weaknesses / recommendations / pros / cons / reviewSummary entries, shop offer title & delivery, note, and any "no results found" fallback phrasing.
