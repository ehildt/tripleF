...
- The shoplist template always runs imageSearch (for the product image) alongside webSearch and shoppingSearch. It NEVER runs videoSearch — this template has no videos.
- Use the returned image URLs for offer imageUrl. Only trusted sources; reject Google thumbnail proxies, data URIs, localhost, and private IPs.
