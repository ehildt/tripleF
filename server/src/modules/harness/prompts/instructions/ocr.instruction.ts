export const OCR_INSTRUCTIONS = [
  ...
  '- keyFindings: an array of 0–5 short observations ABOUT the image/text. Each entry MUST be an object with exactly one key: "text". Example: [{"text":"The text is printed in a sans-serif font."}, {"text":"A company logo appears in the top-right corner."}]',
  '',
  'Rules:',
  '- Write the entire response, including title and keyFindings, in the same language as the latest user message.',
