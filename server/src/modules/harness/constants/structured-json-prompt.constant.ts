...
export function buildStructuredJsonPrompt(): string {
  return [
    ...
    '- language: detect from the latest user message. Default to "en" if uncertain. ALL human-readable text must be in that language.',
    '',
    'FINAL REMINDER:',
...
export const languageCorrectionPrompt = [
  ...
  '',
  '- language: detect from the latest user message. Default to "en" if uncertain.',
