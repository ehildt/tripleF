...
| **SysCtl**    | `sysctl/`                | System control: provider configuration, preprocessing settings, search-engines (Serper tools), system health, tab visibility, widgets, per-session model/config management. |
