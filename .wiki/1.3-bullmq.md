...
3F never does inference on the HTTP thread. All heavy work — prompt processing, compaction, media ingestion — runs as **BullMQ** jobs on **KeyDB** (a Redis-compatible store), with persistence of terminal failures in PostgreSQL.
