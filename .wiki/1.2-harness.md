...
The harness is {fff}'s conversation engine — the part that turns "user typed something with two images" into a streamed, validated, persisted assistant answer. Module root: `server/src/modules/harness/`.
