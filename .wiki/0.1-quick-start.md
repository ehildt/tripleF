...
From a fresh clone to a running {fff} stack in a few commands. Everything happens inside containers — the only host requirements are Docker and (optionally) Ollama for local inference.
