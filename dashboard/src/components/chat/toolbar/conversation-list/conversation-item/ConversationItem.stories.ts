...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: `
A single conversation row in the toolbar conversation list. Displays the conversation title,
context usage percentage, socket binding, and type (temporary/persistent).
`,
      },
    },
  },
