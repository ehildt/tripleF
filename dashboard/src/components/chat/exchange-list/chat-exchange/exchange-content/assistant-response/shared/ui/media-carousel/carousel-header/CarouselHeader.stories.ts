...
/** The dot of the currently playing video is violet (here: the active dot). */
export const PlayingVideo: Story = { args: { playingIndex: 1 } };

/** The playing video's dot stays violet even when it is not centered. */
export const PlayingVideoOffCenter: Story = { args: { playingIndex: 2 } };
