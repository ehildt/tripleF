...
describe('useVideoPosterFallback', () => {
  it('starts at the highest-resolution candidate', async () => {
    ...
    const posterUrl = ref('https://i.ytimg.com/vi/abc123/maxresdefault.jpg');
    const videoUrl = ref('https://www.youtube.com/watch?v=abc123');
  ...
  it('resets to the best candidate when the poster URL changes', async () => {
    mockFetchStatuses({
      ...
      'https://i.ytimg.com/vi/abc123/hqdefault.jpg': 200,
      'https://i.ytimg.com/vi/abc123/mqdefault.jpg': 200,
      'https://i.ytimg.com/vi/def456/maxresdefault.jpg': 200,
    });
    const posterUrl = ref('https://i.ytimg.com/vi/abc123/maxresdefault.jpg');
    const videoUrl = ref('https://www.youtube.com/watch?v=abc123');
    ...
    posterUrl.value = 'https://i.ytimg.com/vi/def456/maxresdefault.jpg';
    videoUrl.value = 'https://www.youtube.com/watch?v=def456';
    await flushPromises();
    expect(currentSrc.value).toBe(
