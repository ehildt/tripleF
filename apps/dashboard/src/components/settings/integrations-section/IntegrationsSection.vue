...
/**
 * The Settings "Integrations" tab: a grid of provider tiles (Serper,
...
import { useSettingsConfig } from '../composables/use-settings-config';
...
<template>
  <SettingsSection :loading="isLoading" :error="hasError || !config">
