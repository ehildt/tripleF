...
export function buildStructuredJsonPrompt(): string {
  return `OUTPUT FORMAT — you must output ONLY valid JSON matching this exact schema:
{
 ...
 */
export const languageCorrectionPrompt = `Your previous response was not valid.
