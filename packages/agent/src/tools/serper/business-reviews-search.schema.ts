...
export const serperBusinessReviewsSearchSchema = z.object({
  ...
  placeId: z
    .string()
    .optional()
    .describe('Google Place ID of the business. Most precise identifier — prefer it when available.'),
...
export type SerperBusinessReviewsSearchInput = z.infer<typeof serperBusinessReviewsSearchSchema>;
