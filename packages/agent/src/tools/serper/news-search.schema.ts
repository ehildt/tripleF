...
export const serperNewsSearchSchema = z.object({
  query: z
    .string()
    .describe(`${STANDALONE_QUERY_DESCRIPTION} Include the newsworthy angle (announcement, release, event, update).`),
...
export type SerperNewsSearchInput = z.infer<typeof serperNewsSearchSchema>;
