...
describe('buildYoutubeThumbnailUrl', () => {
  it('builds a thumbnail for a watch url', () => {
    expect(buildYoutubeThumbnailUrl('https://www.youtube.com/watch?v=abc123def45')).toBe(
  ...
  it('builds a thumbnail for a shorts url', () => {
    expect(buildYoutubeThumbnailUrl('https://www.youtube.com/shorts/abc123def45')).toBe(
      'https://i.ytimg.com/vi/abc123def45/maxresdefault.jpg',
    );
  });
  ...
  it('returns undefined for an invalid id', () => {
    expect(buildYoutubeThumbnailUrl('https://youtu.be/too-short')).toBe(undefined);
  });
});
