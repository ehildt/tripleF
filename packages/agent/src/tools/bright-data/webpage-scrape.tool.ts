...
import { type BrightDataWebpageScrapeInput, brightDataWebpageScrapeSchema } from './webpage-scrape.schema.js';
import type { BrightDataWebpageScrapeResponse } from './webpage-scrape.types.js';

export function createBrightDataWebpageScrape(deps: ToolDependencies): Tool {
  return tool({
    description:
