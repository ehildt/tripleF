  ...
  forbidden: [
    ...
    },
    {
      ...
      to: {
        ...
        // `ai` is an intentional OPTIONAL peer dependency (peerDependenciesMeta.optional)
        // so consumers pulling only /schemas don't need the AI SDK. dependency-cruiser
        // misclassifies it as npm-no-pkg because "peerDependenciesMeta" contains the
        // substring "ependencies" and is not in its NPM2DEP_TYPE map.
        pathNot: ["node_modules/ai"],
      },
    },
    {
